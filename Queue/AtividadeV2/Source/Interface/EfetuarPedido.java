...
public class EfetuarPedido extends JFrame implements ActionListener {
    ...
    public EfetuarPedido(ArrayList<Pedido> ListaPedidos) {
        ...
        ImageIcon imgChecks = new ImageIcon("Source/IMGs/VC32.png");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == LimparP) {
            ...
            Comanda.clear();
            for (int i = 0; i < 8; i++) {
                Checks[i].setIcon(new ImageIcon("Source/IMGs/VC32.png"));
            ...
            for (int i = 0; i < 8; i++) {
                ...
                if ((checkBoxTemp.isSelected() == true)) {
                    if ((e.getSource().equals(checkBoxTemp))) {
                        checkBoxTemp.setIcon(new ImageIcon("Source/IMGs/CH32.png"));
                    }
                    ...
                    checkBoxTemp.setIcon(new ImageIcon("Source/IMGs/VC32.png"));
                }
            }
        }
    }
