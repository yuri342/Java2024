...
public class PainelAdd extends JPanel implements ActionListener {
    ...
    JLabel titulo;
    ArrayList dados;
    ButtonGroup ContatoP;
    
    public PainelAdd(ArrayList dados){
        this.dados = dados;
        ContatoP = new ButtonGroup();
        Salvar = new JButton();
        ...
        ContatoP.add(CelPrincipal);
        ContatoP.add(TelPrincipal);
        ...
        CelPrincipal.setBounds(315, 200, 20, 20);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(Salvar)) {
            ...
            Email.setText("");
            Combo.setSelectedItem("Nenhum");
            Celular.setText("");
            ContatoP.clearSelection();

            JOptionPane.showMessageDialog(null, "ID Cadastrado: \n"+dados.size()+" clientes cadastrados");
        }

        if (e.getSource().equals(Apagar)) {
            inputNome.setText("");
            inputTelefone.setText("");
            Email.setText("");
            Combo.setSelectedItem("Nenhum");
