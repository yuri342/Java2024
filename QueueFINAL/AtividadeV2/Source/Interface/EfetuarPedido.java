...
public class EfetuarPedido extends JFrame implements ActionListener {
    ...
    public EfetuarPedido(ArrayList<Pedido> ListaPedidos) {
        ...
        ImageIcon imgChecks = new ImageIcon("AtividadeV2/Source/IMGs/VC32.png");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == LimparP) {
            ...
            Comanda.clear();
            for (int i = 0; i < 8; i++) {
                Checks[i].setIcon(new ImageIcon("AtividadeV2/Source/IMGs/VC32.png"));
        ...
        if ((PedidoIN.getText().isEmpty()) || (PlacaCarroIN.getText().isEmpty())) {
            ...
            if (e.getSource() == ConfirmaP) {
                ...
                pedido.setPlaca(PlacaCarroIN.getText());
                pedido.setNumeroPedido(PedidoIN.getText());;
                pedido.setStatus("Não Entrege");
                for (int i = 0; i < Comanda.size(); i++) {
                    Produtos produtoT = Comanda.get(i);
                    total += (produtoT.getPreco() * produtoT.getQuantidade());
                }
                pedido.setValorTotal(total);
                for (Produtos produto : Comanda) {
                    pedido.queue(produto);
                }
                System.out.println(pedido.getItemsDoPedido());
                System.out.println(pedido.getPlaca());
            ...
            for (int i = 0; i < 8; i++) {
                ...
                if ((checkBoxTemp.isSelected() == true)) {
                    if ((e.getSource().equals(checkBoxTemp))) {
                        checkBoxTemp.setIcon(new ImageIcon("AtividadeV2/Source/IMGs/CH32.png"));
                    }
                    ...
                    checkBoxTemp.setIcon(new ImageIcon("AtividadeV2/Source/IMGs/VC32.png"));
                }
            }
        }
    }
